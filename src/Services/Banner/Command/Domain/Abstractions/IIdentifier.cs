    ...
    where TValue : notnull
{
    ...
    {
        not null when typeof(TValue) == typeof(Guid) => new GuidIdentifier() as Identifier<TValue>,
        not null when typeof(TValue) == typeof(int) => new IntIdentifier() as Identifier<TValue>,
        not null when typeof(TValue) == typeof(long) => new LongIdentifier() as Identifier<TValue>,
        not null when typeof(TValue) == typeof(string) => new StringIdentifier() as Identifier<TValue>,
